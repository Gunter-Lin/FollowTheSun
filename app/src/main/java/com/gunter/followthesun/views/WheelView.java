...
package com.gunter.followthesun.views;
...
import com.gunter.followthesun.R;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = Color.parseColor("#000000");

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = Color.parseColor("#8E9BB3");
	...
	private static int CURRENT_TEXT_SIZE = 45;
	...
	private int size_dip = 20;
	private int size_current_dip = 30;
	...
	public void setSize(int size,int current_size){
		size_dip = size;
		size_current_dip = current_size;
...
//	mGestureThreshold = (int) (GESTURE_THRESHOLD_DIP * scale + 0.5f);
	...
	private void initResourcesIfNecessary() {
		TEXT_SIZE = dip2px(this.context, size_dip);
		CURRENT_TEXT_SIZE =  dip2px(this.context, size_current_dip);
		if (itemsPaint == null) {
...
//		setBackgroundResource(R.drawable.clamp_scenario_record_choose_bg);
...
//			if(currentItem == addItems){
//				itemsText.append("\n\n");
//			}
//			if(currentItem == addItems-1){
//				itemsText.append("\n");
//			}
		}
	...
	private int getMaxTextLength() {
		...
		return maxText != null ? maxText.length()+100 : 0;
	}
...
//		widthItems -200
	...
	protected void onDraw(Canvas canvas) {
		...
		if (itemsLayout == null) {
			if (itemsWidth == 0) {
//				Log.i("WheelWidth", "itemsWidth:---------- 1");
				calculateLayoutWidth(getWidth(), MeasureSpec.EXACTLY);
			} else {
//				Log.i("WheelWidth", "itemsWidth 0 ");
				createLayouts(itemsWidth, labelWidth);
			}
		}
//		Log.i("WheelWidth", "itemsWidth ="+itemsWidth);
		if (itemsWidth > 0) {
			canvas.save();
...
//		Log.d("WheelWidth", "drawValue");
		...
		// draw current value
		if (valueLayout != null) {
//			Log.d("WheelWidth", " draw current value ");
			canvas.save();
			canvas.translate(0, bounds.top + scrollingOffset-20);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		centerDrawable.setBounds(0, center - offset-10, getWidth(), center
				+ offset+10);

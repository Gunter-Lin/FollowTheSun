package com.gunter.followthesun;
...
import com.gunter.followthesun.views.ArrayWheelAdapter;
import com.gunter.followthesun.views.NumericWheelAdapter;
import com.gunter.followthesun.views.OnWheelScrollListener;
import com.gunter.followthesun.views.WheelView;
            ...
            case R.id.tv_save:
                ...
                switch (type) {
                    case TYPE_AM:
                        ...
                        if (dayTime.compareTo(pmTime) != -1
                                || dayTime.compareTo(FollowTheSunTime.POINT_START) == 0
                                || dayTime.compareTo(FollowTheSunTime.POINT_FINAL) == 0) {
